...
- **Dataset 1 (Taping area):** https://universe.roboflow.com/objectdetect-pu6rn/drywall-join-detect
  - Map to prompt: `"segment taping area"`, `"segment joint/tape"`, `"segment drywall seam"` ...
...
- Short goal summary, data split counts, metrics, 3–4 visual examples (orig | GT | pred),
  brief failure notes, runtime & footprint (train time, avg inference time/image, model size)
